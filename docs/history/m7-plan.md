...
M7 실행 계획 원문이다. 2026-09-15에 `PLAN.md`에서 떼어 이리로 옮겼고, 내용은 옮길 당시 그대로다 — 새 판정을 여기에 덧붙이지 않는다. M7의 잔여 두 건(DoD 1 스톱워치 3회, SC7 예약)은 닫히지 않았고 `docs/ROADMAP.md` M7 절이 계속 들고 있다.
