...
- **추기 (2026-09-26, P1 착수):** P1 착수로 이 ADR의 다시 여는 조건이 충족됐다. 결정 2~8을 `docs/ROADMAP.md` M11 (c)에서 구현한다. 구현은 `qsh.cli/v1`에 optional 필드만 더하는 additive 변경이다. 결정 1이 막은 것은 P0 출고 범위였다.
