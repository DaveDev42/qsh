...
- M9가 신설한 사람용 표면 명령(`pair`, `service`, `trust rename` 등, `ROADMAP.md:118`)은 `db122f5`·`699af37`·`93e8b76`·`bd34c92`로 이미 착지했다. 이 표는 아직 그 표면을 다루지 않으며, 그 커버리지는 M10으로 미룬다(`docs/ROADMAP.md` M10 수용 기준의 M9 이관 항목). §5 g4는 닫혔다.
